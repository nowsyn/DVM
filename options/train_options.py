...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=8200, 
        ...
        parser.add_argument('--validate_start', type=int, default=0, 
            help='start epoch of validating the model')
        parser.add_argument('--validate_freq', type=int, default=1, 
            help='frequency of validating the model')
        ...
        parser.add_argument('--optim', type=str, default='adam', 
            help='which optimizer to use, [optim | sgd]')
        ...
        parser.add_argument('--min_lr', type=float, default=0.00001, 
            help='minimum learning rate for adam when using linear policy')
        parser.add_argument('--lr_policy', type=str, default='linear', 
            help='learning rate policy. [linear | step | plateau | cosine]')
        parser.add_argument('--lr_decay_iters', type=int, default=50, 
            help='multiply by a gamma every lr_decay_iters iterations')
        parser.add_argument('--base_lr', type=float, default=5e-4, 
            help='base learning rate for cyclical learning policy')
        parser.add_argument('--max_lr', type=float, default=1.5e-3, 
            help='maximum learning rate for cyclical learning policy')
        parser.add_argument('--cyclical_step', type=int, default=7500, 
            help='step for cyclical learning policy')
