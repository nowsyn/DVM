...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot_val', type=str, 
            help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='late_fusion_cnn', 
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='matting', 
        ...
        parser.add_argument('--crop_sizes', type=str, default='320,480,640', 
            help='then crop to some size from crop_sizes')
        parser.add_argument("--test_mode", type=str, default='crop', 
            help="test mode, [crop | whole]")
        parser.add_argument('--max_size', type=int, default=1920, 
            help='no more than this size when inference')
